...
`]))),en=function(f){var l=f.card,A=f.request,O=parseFloat(l.market_price),B=(0,u.useContext)(R.tC),Y=B.onDismiss,p=(0,sn.YB)(),h=(0,C.f)(T.w.nftSell),an=h.request,z=h.status,J=h.data,vn=(0,u.useState)(),ln=(0,a.Z)(vn,2),cn=ln[0],xn=ln[1],bn=(0,u.useCallback)((0,_.Z)(v().mark(function gn(){var Q;return v().wrap(function(W){for(;;)switch(W.prev=W.next){case 0:return W.next=2,an(l.id,cn);case 2:if(Q=W.sent,console.log(Q),Y(),!Q.err){W.next=8;break}return E.default.error(Q.err),W.abrupt("return");case 8:E.default.success(Q.info),A();case 10:case"end":return W.stop()}},gn)})),[J,z,cn,A]);return(0,n.jsxs)(H,{children:[(0,n.jsx)("div",{className:"top",children:(0,n.jsx)("h2",{children:(0,n.jsx)(d._H,{id:"component.nft_car.confirm_sale"})})}),(0,n.jsxs)("div",{className:"price",children:[(0,n.jsx)(t.Z,{prefix:(0,n.jsx)("img",{className:"logo",src:nn(),alt:""}),suffix:"CCP",onInput:function(Q){xn(Q.target.value)},style:{width:"60%",borderRadius:"10px",height:"45px",margin:"20px"}}),(0,n.jsxs)("h4",{children:[(0,n.jsx)(d._H,{id:"component.nft_car.price"})," (CCP) ",(0,n.jsxs)("span",{children:["\u2248 $",(cn||0)*1.5]})]})]}),(0,n.jsx)("div",{className:"button",children:z==C.o.wait?(0,n.jsx)(N.Z,{}):(0,n.jsx)(x.b,{text:p.formatMessage({id:"component.nft_car.sell"}),onClick:bn})})]})},X,w=c.ZP.div(X||(X=(0,m.Z)([`
  padding: 20px;
...
`]))),G=function(f){var l,A=f.request,O=(0,u.useContext)(R.tC),B=O.onPresent,Y=(0,u.useContext)(r),p=Y.props,h=(0,d.YB)(),an=(0,$.t)("@@initialState"),z=an.initialState;return p?(0,n.jsxs)(w,{children:[(0,n.jsxs)("h3",{className:"title",children:[p.dog_name,(0,n.jsx)("div",{className:"images"})]}),(0,n.jsx)("div",{className:"center",children:p.is_selling==1&&(0,n.jsxs)("div",{children:[(0,n.jsx)("h3",{children:(0,n.jsx)(d._H,{id:"component.nft_car.sell_price"})}),(0,n.jsxs)("h4",{children:[parseFloat(p.market_price).toFixed(2)," (CCP)",(0,n.jsxs)("span",{children:[" \u2248 $",parseFloat(p.market_price)*1.5]})]})]})}),p.is_selling==1?(0,n.jsx)("div",{className:"button",onClick:function(){return B((0,n.jsx)(i,{request:A,card:p}),390)},children:(0,n.jsx)(x.b,{text:h.formatMessage({id:(z==null||(l=z.currentUser)===null||l===void 0?void 0:l.id)==p.u_id?"component.nft_car.withdraw_the_sale":"component.nft_car.confirm_purchase"})})}):(0,n.jsx)("div",{className:"button",onClick:function(){return B((0,n.jsx)(en,{request:A,card:p}),390)},children:(0,n.jsx)(x.b,{text:h.formatMessage({id:"component.nft_car.confirm_sale"})})})]}):(0,n.jsx)(N.Z,{})},S,on=c.ZP.div(S||(S=(0,m.Z)([`
  //margin-top: 40px;
  //padding: px 12px;
  background: #fff;
  border-radius: 10px;
...
`]))),mn=function(){var f=(0,u.useContext)(r),l=f.props;return l?(0,n.jsxs)(dn,{children:[(0,n.jsxs)("h3",{children:[(0,n.jsx)("span",{children:(0,n.jsx)(d._H,{id:"pages.market.owner"})}),(0,n.jsx)("span",{children:l.u_id})]}),(0,n.jsxs)("h3",{children:[(0,n.jsx)("span",{children:"Token ID"}),(0,n.jsx)("span",{children:l.id})]}),(0,n.jsx)(rn,{})]}):(0,n.jsx)(N.Z,{})},tn,hn=c.ZP.div(tn||(tn=(0,m.Z)([`
  padding: 20px;
  box-sizing: border-box;
